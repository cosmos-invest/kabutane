...
PUBLIC_FIELDS = (
    ...
    "dividend_expected_events_per_period", "dividend_partial_event_period_count",
...
def build_public_payload(source: dict[str, Any]) -> dict[str, Any]:
    ...
    return {
        ...
        "dividend_partial_event_record_count": int(source.get("dividend_partial_event_record_count") or 0),
