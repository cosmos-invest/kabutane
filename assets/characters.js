...
const characterGuide = (() => {
  ...
  const messages = {
    ...
    detail: [
      ...
      { character: "aile", text: "有料APIや適時開示には接続していないよ。大事な企業情報は、投資前に会社の公式IRでも確認しよう。" },
    ...
    howto: [
      ...
      { character: "aile", text: "自分のお金を動かす前に、なぜ買うのか、どこで撤退するのかを説明できるまで練習しよう。" },
    ],
    backtest: [
      { character: "cosmos", text: "成績が一番高い条件だけでなく、最大下落と取引数も一緒に確認しよう🌸" },
      { character: "aile", text: "バックテストには実際の約定との差や、未来の情報が混ざるリスクもあるよ。前提条件を確認して使おう。" },
    ],
    replay: [
      { character: "lumo", text: "ここは何度失敗しても大丈夫な場所！ まず損切りを決めてから、1回分の株数を考えよう✨" },
      { character: "aile", text: "月足の状態を待ちたい時は『月末へ』で進められるよ。途中の損切り・利確判定も日足の順番で処理するよ。" },
